 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn   | Ctrl | Alt  | GUI  |Lower |Sp/Sh |  Sp  |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {MO(_FN), KC_LCTL, KC_LALT, KC_LGUI, LOWER,  MT(MOD_RSFT, KC_SPC), KC_SPC,   RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT} // Would be nice to have way to swap the two space keys for better right hand support
},
 ...
 */
[_NUM] = {
  {_______,       KC_MINUS,     KC_KP_9,     KC_KP_8, KC_KP_7,     _______,     _______, KC_KP_7,     KC_KP_8,       KC_KP_9,       KC_MINUS,     _______},
  {_______,     KC_KP_PLUS,     KC_KP_6,     KC_KP_5, KC_KP_4,     _______,     _______, KC_KP_4,     KC_KP_5,       KC_KP_6,     KC_KP_PLUS,     _______},
  {_______,    KC_KP_SLASH,     KC_KP_3,     KC_KP_2, KC_KP_1, KC_KP_EQUAL, KC_KP_EQUAL, KC_KP_1,     KC_KP_2,       KC_KP_3,    KC_KP_SLASH,     _______},
  {_______, KC_KP_ASTERISK,   KC_KP_DOT, KC_KP_COMMA, KC_KP_0, KC_KP_ENTER, KC_KP_ENTER, KC_KP_0, KC_KP_COMMA,     KC_KP_DOT, KC_KP_ASTERISK,     _______}
},

// FN
[_FN] = {
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_PSCREEN,  KC_PAUSE,     KC_INSERT,    KC_DEL}, 
  {_______, KC_SLCK, KC_PAUS, _______, _______, _______, KC_MEDIA_PLAY_PAUSE, _______, KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
